/*
	...
	***********************************************************************
	*	FILE NAME:		usart_serial_example_pdc.c
	*
	*	PURPOSE:	This example demonstrates the normal (serial) mode provided by the USART
	*				peripherals.
	*
	...
	*	NOTES:	 
	*	
	*	REQUIREMENTS/ FUNCTIONAL SPECIFICATION REFERENCES:	This package can be used 
	*				with all SAM3X with UART/USART and PDC.	
	*
	*	DEVELOPMENT HISTORY:		
	*	02/28/2015		Created.
	*
